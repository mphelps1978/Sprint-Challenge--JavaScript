...
zooAnimals.forEach(function(currentValue) {
	let name = currentValue.animal_name;
	let sciName = currentValue.scientific_name;
	displayNames.push(`Name: ${name} Scientific: ${sciName}`);
});
...
zooAnimals.filter(function(currentValue) {
	if (currentValue.population < 5) lowPopulationAnimals.push(currentValue);
});
